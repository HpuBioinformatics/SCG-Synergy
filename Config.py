...
def parse():
    ...
    p.add_argument('--threshold',type = int, default = 30,help = 'the threshold of positive samples') 
    ...
    p.add_argument('--alpha', type = float, default = 0.2, help = 'the parameters of the auxiliary task (weight for Contrastive Loss)') 
    ...
    p.add_argument('--temperature', type=float, default=0.5, help='temperature parameter tau for contrastive loss')
